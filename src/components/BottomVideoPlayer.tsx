...
interface BottomVideoPlayerProps {
  isVisible: boolean
...
export default function BottomVideoPlayer({ isVisible, shouldStartPlaying, onPlaybackStarted }: BottomVideoPlayerProps) {
        ...
        >
          ...
          <div className={`flex-shrink-0 ${isFullyExpanded ? 'mr-0' : 'mr-3 sm:mr-4'}`}>
            <div className={`bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl overflow-hidden shadow-lg transition-all duration-500 ${
              ...
              {isFullyExpanded ? (
                // Full video player when expanded
                <iframe
                  ref={videoRef}

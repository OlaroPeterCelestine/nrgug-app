            ...
            children: [
              Expanded(
                child: _buildStatItem(
                  ...
                  label: 'Listening',
                  value: '${_listeningHours.toStringAsFixed(1)}h',
                ),
              ),
              Container(
                width: 1,
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              _buildStreakStat('Current', '$_streakDays', 'days'),
              Container(
                width: 1,
                height: 50,
                color: Colors.white.withOpacity(0.3),
              ),
              _buildStreakStat('Longest', '$_longestStreak', 'days'),
            ],
          ),
          if (_streakDays > 0) ...[
            const SizedBox(height: 16),
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      _streakDays == 1
                          ? 'Keep it up! Open the app tomorrow to continue your streak!'
                          : 'Amazing! You\'ve opened the app $_streakDays days in a row!',
                      style: const TextStyle(
                        color: Colors.white,
                        fontSize: 12,
                      ),

...
"[project]/src/config/streaming.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const STREAMING_CONFIG = {
    ...
    audio: {
        primary: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_AUDIO_STREAM_URL || 'https://dc4.serverse.com/proxy/nrgugstream/stream',
        backup: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_AUDIO_STREAM_URL_BACKUP || 'https://live2.tensila.com/nrg-radio-v-1.nrgug/player.html',
    ...
    video: {
        primary: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_VIDEO_STREAM_URL || 'https://live2.tensila.com/nrg-radio-v-1.nrgug/player.html',
        backup: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_VIDEO_STREAM_URL_BACKUP || 'https://dc4.serverse.com/proxy/nrgugstream/stream',
    ...
    // API configuration
    api: {
        baseUrl: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL || 'https://nrgug-api-production.up.railway.app',
        endpoints: {
...
const getStreamUrl = function(type) {
    let useBackup = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
    const config = STREAMING_CONFIG[type];
    return useBackup ? config.backup : config.primary;
};
const getApiUrl = (endpoint)=>{
    return "".concat(STREAMING_CONFIG.api.baseUrl).concat(STREAMING_CONFIG.api.endpoints[endpoint] || endpoint);
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$streaming$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/config/streaming.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/api-utils.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';

...
;
function Header() {
    let { createPlayer } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    _s();
...
function OnAirCarousel() {
    ...
    const [selectedDay, setSelectedDay] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(getCurrentDayFilter());
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    const fetchShows = async ()=>{
        try {
            ...
            console.log('📅 Shows by day:', (data === null || data === void 0 ? void 0 : data.reduce((acc, show)=>{
    ...
    const getFilteredShows = ()=>{
        ...
        console.log('📋 All shows:', shows.map((s)=>({
                id: s.id,
                name: s.show_name,
                day: s.day_of_week
            })));
        ...
        console.log('📝 Filtered shows:', filteredShows.map((s)=>({
                id: s.id,
                name: s.show_name,
                day: s.day_of_week
            })));
...
_s(OnAirCarousel, "nSkUbA8qbYd4fifS7IkyC7LaISc=");
_c = OnAirCarousel;
var _c;
...
function NewsSection() {
    ...
    const mapToR2Url = (url)=>{
        ...
        if (url.includes('nrgug-api-production.up.railway.app/uploads/')) {
            ...
            return "https://pub-1a0cc46c23f84b8ebf3f69e9b90b4314.r2.dev/nrgug".concat(localPath);
        }
        // If it's already an R2 URL, return as is
        if (url.includes('pub-1a0cc46c23f84b8ebf3f69e9b90b4314.r2.dev') || url.includes('pub-6481c927139b4654ace8022882acbd62.r2.dev') || url.includes('pub-56fa6cb20f9f4070b3dcbdf365d81f80.r2.dev')) {
            return url;
        }
        return url;
    };
        ...
        children: [
            ...
            loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: videos.map((video)=>{
                    ...
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex flex-col rounded-lg hover:bg-gray-900/50 transition-colors",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("iframe", {
                                className: "w-full ".concat(videoHeight, " rounded-lg flex-shrink-0"),
                                src: embedUrl,
                                title: video.title,
                                frameBorder: "0",
